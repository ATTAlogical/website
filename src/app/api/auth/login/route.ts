...
export async function POST(req: NextRequest) {
  ...
  // TEMP DEBUG — remove once login works
  ...
  if (!envHash) {
    console.error("[auth/login] ADMIN_PASSWORD_HASH is not set in process.env");
  ...
  try {
    ...
    console.error("[auth/login] bcrypt.compare threw:", e);
  }
